...
public class LoginScreenController implements Initializable {
    ...
    private void login_Action (ActionEvent event) throws IOException {
        ...
        if (login_Query(username, password)) {
            ...
            String filename = "src/appMain/logs.txt";
            FileWriter user_Logged = new FileWriter(filename, true);
            PrintWriter output = new PrintWriter(user_Logged);
            output.println(txt_username.getText() + " logged in on " + LocalDateTime.now()); 
            System.out.println(txt_username.getText() + " logged in on " + LocalDateTime.now());
            output.close();
            ...
            try {
                ...
                System.out.println("Current userId: " + User.get_Current_User_ID() + " userName: " + User.get_Current_Username());
